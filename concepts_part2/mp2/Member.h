...
enum SwimState {
  ...
  STATE_DEAD, // dead -> will tell others and eventually drop from membership
              // list.
  DUMMYLASTSTATE
};
...
public:
   ...
   */
  Member()
      : inited(false), inGroup(false), bFailed(false), nnb(0), heartbeat(0),
        pingCounter(0), timeOutCounter(0) {}
  // copy constructor
